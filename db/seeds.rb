...
user3 = User.create({first_name: "Dave", last_name:"T", email:"dt@ga.co", password:"123", current_city:"Oakland"})
user4 = User.create({first_name: "Chuong", last_name:"Dao", email:"cdao@ga.co", password:"123", current_city:"San Francisco"})
user5 = User.create({first_name: "Michal's Dad", last_name:"V", email:"mydad@ga.co", password:"123", current_city:"Prague"})
...
p5 = Post.fifth
p5.update(review_title: "Bad food in London", review: "Lots of Potatoes, my son loves potatoes.consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis.")

p6 = Post.third_to_last
p6.update(review_title: "Fun in the Sun", review: "dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. U.")

p7 = Post.second_to_last
p7.update(review_title: "Fun in the big apple", review: " Sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis.")

p8 = Post.last
p8.update(review_title: "Met the Queen", review: "dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. U.")
